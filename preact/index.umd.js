(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('preact/hooks'), require('preact')) :
    typeof define === 'function' && define.amd ? define(['exports', 'preact/hooks', 'preact'], factory) :
    (global = global || self, factory(global.baitshop = {}, global.preact, global.React));
}(this, (function (exports, preact, React) { 'use strict';
    ...
    function createSharedHook(HookClass) {
        ...
        return [
            ...
            () => preact.useContext(sharedHookContext)
        ];
    }
